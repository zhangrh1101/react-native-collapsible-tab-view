...
import { useAnimatedDynamicRefs, useContainerRef, useTabProps, usePageScrollHandler } from './hooks'
import {
  CollapsibleProps,
  CollapsibleRef,
  ContextType,
    ...
    (
      ...
      React.useEffect(() => {
        if (!firstRender.current) {
          ...
          containerRef.current?.setPage(index.value)
        }
